# Resumo de Produtos e Serviços - Konnected
...
## 📇 Cartões de Visita
- **Cartão de Visita NFC (por unidade):** R$ 30,00 *(Pedido mínimo recomendado: 4 unidades)*

## 🌐 Biosite
- **Criação + Publicação (domínio do cliente):** R$ 150,00 *(Valor único)*
- **Manutenção Mensal (Hospedagem + SSL + Suporte):** R$ 29,90/mês
- **Plano Anual com desconto:** R$ 279,00/ano

## 📍 Google Meu Negócio
- **Configuração Completa sem fotos:** R$ 97,00
- **Configuração + Fotos (enviadas pelo cliente):** R$ 137,00
...
## 📦 Pacotes Integrados
*(Nota: Manutenção mensal do Biosite de R$ 29,90/mês cobrada separadamente em todos os pacotes)*
